                ...
                <div className="grid grid-cols-1 gap-2">
                    {sortOptions.map((option) => (
                        <button
                            ...
                            className={`flex items-center justify-between px-6 py-4 rounded-xl border transition-all text-[10px] font-black uppercase tracking-widest ${sortBy === option.value
                ...
                {isCategoriesOpen && (
                    ...
                    >
                        <button
                            ...
                            className={`px-6 py-4 rounded-xl border text-left text-[10px] font-black uppercase tracking-widest transition-all ${!activeCategoryId
                        ...
                        {(Array.isArray(categories) ? categories : []).map((category) => (
                            <button
                                ...
                                className={`px-6 py-4 rounded-xl border text-left text-[10px] font-black uppercase tracking-widest transition-all ${activeCategoryId === category.id
                                        ? "bg-brand-600 text-white border-brand-600 shadow-xl shadow-brand-600/20"
