    ...
    return (
        <div className="max-w-7xl mx-auto space-y-8 pb-12">
            ...
            <div className="flex items-center justify-between">
                <div>
                    <h1 className="text-4xl font-outfit font-black tracking-tight text-surface-950 mb-2 uppercase">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                {stats.map((stat, idx) => (
                    ...
                    >
                        ...
                        <h3 className="text-3xl font-outfit font-black text-surface-950 relative z-10 tracking-tight">{stat.value}</h3>
                    </motion.div>
                ))}
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                <div className="lg:col-span-2 bg-white p-6 rounded-2xl border border-surface-200 shadow-sm min-h-[400px] flex flex-col">
                    <h3 className="text-xl font-outfit font-black text-surface-950 mb-6 border-b border-surface-100 pb-4 uppercase tracking-tight">Sales Analytics</h3>
                ...
                <div className="bg-white p-6 rounded-2xl border border-surface-200 shadow-sm h-[400px]">
                    <h3 className="text-xl font-outfit font-black text-surface-950 mb-6 border-b border-surface-100 pb-4 uppercase tracking-tight">Recent Orders</h3>
